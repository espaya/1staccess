...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Policies And Procedures Orientation Acknowledgement - 1staccess Home Care</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="printArea" class="row d-flex align-items-center justify-content-center">
                            <div class="col-xl-8">
                              ...
                              @if(!empty($policyData[0]['applicant_id']))
                                <div class="row g-4">
                                       <div class="col-md-12">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <div class="form-control-wrap">
                                             <p>
                                             <span class="form-label">Date: </span>{{ \Carbon\Carbon::parse($policyData[0]['created_at'])->format('M d, Y')}}</p>
                                            </div>
                                          </div>
                                       </div>
                                 </div>   
                            @else
                            <form onsubmit="submitForm();" action="{{ route('policies-and-procedures.store') }}" method="post" enctype="multipart/form-data" class="row g-4">
                                       @csrf
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label for="inputEmail4" class="form-label">Employee Signature</label>
