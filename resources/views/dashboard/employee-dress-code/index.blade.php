                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    ...
                                    <p><strong>1st Access Home Care Incorporated strives to present a professional and safe health care image to patients’ families, the community, and other health care professionals. 1st Access Home Care Incorporated staff members adhere to the following standards in their dress appearance.</strong></p>
                                        ...
                                        <br>
                                        @if(!empty($dressCodeData[0]['applicant_id']))
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <p>{{ \Carbon\Carbon::parse($dressCodeData[0]['created_at'])->format('M d, Y')}}</p>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                        <form  onsubmit="submitForm();" action="{{route('employee-dress-code')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
