...
<html lang="en">
  <head>
    ...
    <title>Login - First Access Homecare Inc</title>
                        ...
                        <div class="row gy-3">
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <div class="form-control-wrap ">
                                <input name="email" type="text" class="form-control @error('email') is-invalid @enderror" id="email" autocomplete="off">
                              </div>
                              @error('email')
                          ...
                          <div class="col-12">
                              <div class="d-flex flex-wrap justify-content-between">
                                ...
                                <a href="auth-reset-fancy.html.htm" class="small">Forgot Password?</a>
                              </div></div><div class="col-12">
                                <div class="d-grid">
                                  <button name="sbmit" class="btn btn-primary" type="submit">Login to account</button>
                                </div>
                              </div>
                            </div>
                          </form>
