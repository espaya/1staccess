...
class InfectionControlAgreementController extends Controller
{
    ...
    public function index(UserProfileService $userProfileService)
    {
        ...
        $infection = DB::table('infection_control_agreement')->where('applicant_id', $userID)->get();

        $infectionData = [];

        foreach($infection as $item){
        ...
        return view('dashboard.infection-control-agreement.index', 
        [
    ...
    public function store(Request $request)
    {
        ...
        $infection = new InfectionControlAgreement();
         ...
         return redirect()->back()->with('success', 'Following Infection Control Agreement Signed Successfully');
